...
$(function() {
   ...
   $(".panel__item_wishlist").click(function(){
	   this.classList.toggle("panel-active");
	   $(".dropdownWwishlist").slideToggle( "slow" );
   });

    $('#portfolio').mixItUp({
		 controls: {
		 	enable:true,
		 	activeClass:'filter-nav__item_active'
		 }
	});
...
//////////////////////////////////////
    ...
    if ($this.next().hasClass('show') && $this.hasClass('accordion__toggle_active')) {
        $this.next().removeClass('show');
        $this.removeClass('accordion__toggle_active');
        $this.next().slideUp(350);
    } else {
        $this.parent().parent().find('li .inner').removeClass('show');
        $this.parent().parent().find('li .accordion__toggle').removeClass('accordion__toggle_active');
...
// Progress bar
 function PhotoshopBar() {
    const elem = $('#Bar');
    const elemText = $('#label');
    let width = 0;
    ...
    function frame() {
        if (width >= 75) {
            ...
            elemText.css("left",  '100%');
            elemText.text (width*1+ '%');
       }
...
function WordPressBar() {
    const elem = $('#Bar-2');
    const elemText = $('#label-2');
    let width = 0;
    const id = setInterval(framee, 10);
    function framee() {
        if (width >= 50) {
            clearInterval(id);
        } else {
...
function PhotographyBar() {
    const elem = $('#Bar-4');
    const elemText= $('#label-4');
    let width = 0;
    const id = setInterval(framee, 10);
    function framee() {
        if (width >= 36) {
...
var showBar = true;
    $(window).on("scroll", function() {
        ...
        $("#aboutServices").each(function(){

            var cPosBar = $(this).offset().top;
            var topWindowBar = $(window).scrollTop();

            if (cPosBar < topWindowBar + 200  ) {
                PhotoshopBar();
                WordPressBar();
                eCommerceBar();
                PhotographyBar();
